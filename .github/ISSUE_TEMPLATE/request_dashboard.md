...
about: Request a new dashboard for the SigInsight Dashboards repository
...
<!-- Use this template to request a new dashboard for the SigInsight Dashboards repository. Providing detailed information will help us understand your needs better and speed up the dashboard creation process. -->
...
Please include relevant dashboard structure, naming conventions, and screenshots with your request.
