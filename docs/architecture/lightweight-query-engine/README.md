...
- [Schema 收敛设计：面向当前查询引擎的保守精简](schema-convergence.md)
...
- [M16：Canonical ClickHouse Schema Cutover](milestones/m16-canonical-schema-cutover.md)
...
| M16 Canonical ClickHouse Schema Cutover | In Progress | 将 SigInsight reader/Catalog 与 Collector v2.0.0 切换至 direct canonical schema，并进行停机协作验证 |
