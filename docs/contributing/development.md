...
Welcome! This guide will help you set up your local development environment for SigInsight. Let's get you started! 🚀
...
2. Clone the repository:
   ```bash
   git clone https://github.com/SigInsight/SigInsight.git
   ```
...
SigInsight has three main components: Clickhouse, Backend, and Frontend. Let's set them up one by one.
...
This command:
- Starts ClickHouse as a single node
...
This command:
- Starts the SigInsight OpenTelemetry Collector
...
You can now send telemetry data to your local SigInsight instance:
