...
func TestGetWithStrings(t *testing.T) {
	t.Setenv("SIGINSIGHT_K1_K2", "string")
	t.Setenv("SIGINSIGHT_K3__K4", "string")
	t.Setenv("SIGINSIGHT_K5__K6_K7__K8", "string")
	t.Setenv("SIGINSIGHT_K9___K10", "string")
	t.Setenv("SIGINSIGHT_K11____K12", "string")
...
func TestGetWithGoTypes(t *testing.T) {
	t.Setenv("SIGINSIGHT_BOOL", "true")
	t.Setenv("SIGINSIGHT_STRING", "string")
	t.Setenv("SIGINSIGHT_INT", "1")
	t.Setenv("SIGINSIGHT_SLICE", "[1,2]")
	expected := map[string]any{
		"bool":   "true",
		"int":    "1",
		"slice":  "[1,2]",
