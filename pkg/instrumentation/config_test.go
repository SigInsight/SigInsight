...
func TestNewWithEnvProvider(t *testing.T) {
	t.Setenv("SIGINSIGHT_INSTRUMENTATION_LOGS_LEVEL", "debug")
	t.Setenv("SIGINSIGHT_INSTRUMENTATION_METRICS_READERS_PULL_EXPORTER_PROMETHEUS_PORT", "1111")
	t.Setenv("SIGINSIGHT_INSTRUMENTATION_TRACES_ENABLED", "true")
