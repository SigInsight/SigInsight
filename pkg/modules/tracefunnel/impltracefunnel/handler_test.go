...
func TestHandler_List(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/v5/trace-funnels/list", nil)
...
func TestHandler_Get(t *testing.T) {
	...
	orgID := valuer.GenerateUUID()
	req := httptest.NewRequest(http.MethodGet, "/api/v5/trace-funnels/"+funnelID.String(), nil)
...
func TestHandler_Delete(t *testing.T) {
	...
	funnelID := valuer.GenerateUUID()
	orgID := valuer.GenerateUUID()
	req := httptest.NewRequest(http.MethodDelete, "/api/v5/trace-funnels/"+funnelID.String(), nil)
	req = mux.SetURLVars(req, map[string]string{"funnel_id": funnelID.String()})
	req = req.WithContext(authtypes.NewContextWithClaims(req.Context(), authtypes.Claims{
		OrgID: orgID.String(),
	}))
