...
import { HistogramChartProps } from 'container/PanelVisualization/charts/types';
...
jest.mock('container/PanelVisualization/hooks/useScrollWidgetIntoView', () => ({
	useScrollWidgetIntoView: jest.fn(),
}));

jest.mock('container/PanelVisualization/charts/Histogram/Histogram', () => ({
	__esModule: true,
...
jest.mock(
	'container/PanelVisualization/components/ChartManager/ChartManager',
	() => ({
		__esModule: true,
		default: (): JSX.Element => (
