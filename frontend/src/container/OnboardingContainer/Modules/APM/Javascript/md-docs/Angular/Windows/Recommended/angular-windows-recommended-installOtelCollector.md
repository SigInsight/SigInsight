...
CORS error which can hinder sending your Traces to SigInsight Cloud. See the code snippet below to understand how you can enable CORS in your config file:
