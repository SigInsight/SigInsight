...
**NOTE:** Once the task is running, you should be able to see SigInsight sidecar container logs in CloudWatch Logs because we have set the logDriver parameter to be `awslogs` in our task definition.


## Verify data in SigInsight
