...
Once you have completed the prerequisites, you can start monitoring your Azure Container App's system metrics with SigInsight. Here's how you can do it:
...
This query lets you monitor system metrics of your Azure Container App in SigInsight.
