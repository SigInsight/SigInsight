...
import useGetTraceWaterfall from 'hooks/trace/useGetTraceWaterfall';
import useUrlQuery from 'hooks/useUrlQuery';
import { defaultTo } from 'lodash-es';
import { Span, TraceDetailURLProps } from 'types/api/trace/getTraceWaterfall';

import NoData from './NoData/NoData';

import './TraceDetail.styles.scss';

function TraceDetails(): JSX.Element {
	const { id: traceId } = useParams<TraceDetailURLProps>();
